...
= 2.5.8 =
* Preserve canonical colour tones on live related-service cards.

= 2.5.7 =
* Restore original CTA copy for untouched importer blanks while preserving deliberate editor removals.

= 2.5.6 =
* Companion release for the refined FAQ follow-up layout.

= 2.5.5 =
* Preserve service-page design labels after restoring a service to its original content.
...
* Restores canonical managed services affected by the earlier publishing validator.
