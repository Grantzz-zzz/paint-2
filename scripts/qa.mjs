...
try {
  ...
  check((await page.locator('.google-reviews .slider-controls>span').first().textContent()).includes('/ 10'),'homepage reviews: carousel does not contain exactly 10 reviews')
  ...
  check((await faqReviews.locator('.slider-controls>span').textContent()).includes('/ 10'),'FAQs: carousel does not contain exactly 10 reviews')
