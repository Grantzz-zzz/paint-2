...
- [x] Add a clear Services dropdown exposing all nine service pages on desktop and mobile
...
**Frontend navigation refinement.** The 15-page frontend is live, and a clean Services dropdown exposes all nine service subpages on desktop and mobile. Automated browser QA passes across every route and viewport. Remaining work can focus on frontend content polish, final photography and client-confirmed copy; form-backend integration is outside the current scope.
