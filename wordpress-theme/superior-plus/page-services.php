...
<main id="main-content" class="inner-main">
	<?php spp_breadcrumbs(); ?>
	<?php spp_page_hero( array( 'eyebrow' => 'Everything under one careful eye', 'title' => 'Painting & property services', 'accent' => 'made beautifully simple.', 'intro' => get_the_excerpt() ?: 'From complete residential and commercial painting to the preparation and repairs behind a lasting finish, our team can coordinate more of your project from one place.', 'tone' => 'gold', 'image' => 'projects/commercial/commercial-12.webp' ) ); spp_trust_strip(); ?>
