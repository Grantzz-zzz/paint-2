...
<main id="main-content" class="inner-main">
	<?php spp_breadcrumbs(); ?>
	<?php spp_page_hero( array( 'eyebrow' => $field( 'eyebrow' ), 'title' => get_the_title(), 'accent' => $field( 'accent' ), 'intro' => get_the_excerpt() ?: wp_strip_all_tags( get_the_content() ), 'tone' => $tone, 'image' => $field( 'image', 'projects/exterior/exterior-07.webp' ), 'image_url' => $image_url, 'alt' => get_the_title() . ' project by Superior Plus Painting' ) ); spp_trust_strip(); ?>
