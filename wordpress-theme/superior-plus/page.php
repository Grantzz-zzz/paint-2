...
<main id="main-content" class="inner-main">
	<?php spp_breadcrumbs(); ?>
	<?php spp_page_hero( array( 'eyebrow' => 'Superior Plus Painting', 'title' => get_the_title(), 'accent' => 'made with care.', 'intro' => get_the_excerpt(), 'image' => 'projects/exterior/exterior-07.jpg' ) ); ?>
