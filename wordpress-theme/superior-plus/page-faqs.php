...
<main id="main-content" class="inner-main">
	<?php spp_breadcrumbs(); ?>
	<?php spp_page_hero( array( 'eyebrow' => 'Straight answers before we start', 'title' => 'Frequently asked questions', 'accent' => 'made easy.', 'intro' => get_the_excerpt() ?: 'Clear answers about quoting, preparation, scheduling, products and what to expect from our team.', 'tone' => 'cream', 'image' => 'projects/interior/interior-04.jpg' ) ); ?>
