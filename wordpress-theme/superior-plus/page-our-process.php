...
<main id="main-content" class="inner-main">
	<?php spp_breadcrumbs(); ?>
	<?php spp_page_hero( array( 'eyebrow' => 'A proven path to a better finish', 'title' => 'Our painting process', 'accent' => 'planned down to the detail.', 'intro' => get_the_excerpt() ?: 'Outstanding painting starts with careful planning, detailed preparation and clear communication.', 'tone' => 'gold', 'image' => 'projects/commercial/commercial-06.jpg' ) ); spp_trust_strip(); ?>
