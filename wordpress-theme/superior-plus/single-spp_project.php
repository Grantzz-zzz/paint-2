...
<main id="main-content" class="inner-main">
	<?php spp_breadcrumbs(); spp_page_hero( array( 'eyebrow' => 'Superior Plus project', 'title' => get_the_title(), 'accent' => 'completed with care.', 'intro' => get_the_excerpt(), 'tone' => 'green', 'image' => 'projects/exterior/exterior-07.jpg', 'image_url' => $image ) ); ?>
