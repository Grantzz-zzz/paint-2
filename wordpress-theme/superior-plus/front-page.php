...
<main id="main-content">
	<section class="wp-home-hero">
		<div class="hero-bg"><img src="<?php echo esc_url( spp_asset( 'projects/brand/home-hero-ai.webp' ) ); ?>" alt="<?php esc_attr_e( 'Superior Plus painter applying a fresh exterior finish to a Melbourne home', 'superior-plus' ); ?>" fetchpriority="high"></div>
