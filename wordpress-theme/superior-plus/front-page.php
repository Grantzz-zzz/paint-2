...
<main id="main-content">
	<section class="wp-home-hero">
		<div class="hero-bg"><img src="<?php echo esc_url( spp_asset( 'projects/brand/home-hero-ai-v2.webp' ) ); ?>" alt="<?php esc_attr_e( 'Superior Plus painters transforming a premium Melbourne home exterior', 'superior-plus' ); ?>" fetchpriority="high"></div>
	...
	<section id="projects" class="wp-projects"><div class="container"><?php spp_section_intro( 'Recent work', 'Real properties.', 'Real transformations.', 'Client-supplied photography from completed Superior Plus projects across Melbourne.' ); ?><div class="wp-project-grid"><article class="wp-project-card"><img src="<?php echo esc_url( spp_asset( 'projects/interior/interior-04.webp' ) ); ?>" alt="Completed modern interior painting project" loading="lazy"><span>Interior project · Melbourne</span></article><article class="wp-project-card"><img src="<?php echo esc_url( spp_asset( 'projects/exterior/exterior-07.webp' ) ); ?>" alt="Completed exterior house painting project" loading="lazy"><span>Exterior transformation</span></article><article class="wp-project-card"><img src="<?php echo esc_url( spp_asset( 'projects/commercial/commercial-12.webp' ) ); ?>" alt="Commercial painting project" loading="lazy"><span>Commercial precision</span></article></div></div></section>
