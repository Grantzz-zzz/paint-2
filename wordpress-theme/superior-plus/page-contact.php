...
<main id="main-content" class="inner-main">
	<?php spp_breadcrumbs(); ?>
	<?php spp_page_hero( array( 'eyebrow' => 'Tell us what you’re planning', 'title' => 'Get in touch', 'accent' => 'and get a fresh start.', 'intro' => get_the_excerpt() ?: 'Share a few details about your property and the work you have in mind.', 'tone' => 'green', 'image' => 'projects/exterior/exterior-07.jpg' ) ); ?>
