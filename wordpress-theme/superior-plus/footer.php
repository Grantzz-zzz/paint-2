...
<footer class="site-footer">
	<div class="container footer-grid">
		...
		<div><h4><?php esc_html_e( 'Get in touch', 'superior-plus' ); ?></h4><a href="tel:<?php echo esc_attr( spp_phone_href() ); ?>"><?php echo esc_html( spp_phone() ); ?></a><a href="mailto:<?php echo esc_attr( antispambot( spp_email() ) ); ?>"><?php echo esc_html( antispambot( spp_email() ) ); ?></a><span><?php echo esc_html( get_theme_mod( 'spp_location', 'Melbourne, Victoria' ) ); ?></span><div class="footer-socials" aria-label="<?php esc_attr_e( 'Follow Superior Plus Painting', 'superior-plus' ); ?>"><a class="footer-social-badge facebook" href="https://www.facebook.com/people/Superior-Plus-Painting-Remodeling-Services/100075874374049/" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Facebook', 'superior-plus' ); ?></a><a class="footer-social-badge instagram" href="https://www.instagram.com/sppainting.remodeling" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Instagram', 'superior-plus' ); ?></a></div></div>
	</div>
